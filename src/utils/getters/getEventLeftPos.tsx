...
export function getEventLeftPos(extEvent: ExtendedEvent, extEvents: ExtendedEvent[]): string {
	...
	const eventIndex = filteredExtEvents.findIndex(event => event.eventId === extEvent.eventId);
